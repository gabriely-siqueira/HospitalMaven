...
public class TelaBuscaInternacao extends javax.swing.JDialog {

  
    public TelaBuscaInternacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Data Internação", "Hora Internação", "Data Alta", "Hora Alta", "Observação ", "Status"
            }
        ));
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "DATA INTERNACAO", "HORA INTERNACAO", "DATA ALTA", "HORA ALTA" }));
