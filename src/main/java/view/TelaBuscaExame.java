...
public class TelaBuscaExame extends javax.swing.JDialog {

  
    public TelaBuscaExame(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "NOME", "TIPO", "STATUS" }));
