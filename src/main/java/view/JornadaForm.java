...
public class JornadaForm extends javax.swing.JDialog {
    
  public JornadaForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public JFormattedTextField getDataFinal() {
        return dataFinal;
    }
    ...
    public JFormattedTextField getDataInicial() {
        return dataInicial;
    }
    ...
    public void setFuncionario(JTextField funcionario) {
