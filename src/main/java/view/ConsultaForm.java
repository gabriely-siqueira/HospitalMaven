...
public class ConsultaForm extends javax.swing.JFrame {
    ...
    public JFormattedTextField getAnamnese() {
        return anamnese;
    }

    public void setAnamnese(JFormattedTextField anamnese) {
        this.anamnese = anamnese;
    }

    public JFormattedTextField getDataConsulta() {
        return dataConsulta;
    }

    public void setDataConsulta(JFormattedTextField dataConsulta) {
        this.dataConsulta = dataConsulta;
    }

    public JFormattedTextField getDiagnostico() {
        return diagnostico;
    }

    public void setDiagnostico(JFormattedTextField diagnostico) {
        this.diagnostico = diagnostico;
    }

    public JFormattedTextField getHorarioConsulta() {
        return horarioConsulta;
    }

    public void setHorarioConsulta(JFormattedTextField horarioConsulta) {
    ...
    public void setObservacoes(JFormattedTextField observacoes) {
        this.observacoes = observacoes;
    }

    public JFormattedTextField getPrescricao() {
        return prescricao;
    }

    public void setPrescricao(JFormattedTextField prescricao) {
        this.prescricao = prescricao;
    }

    public JFormattedTextField getResponsavel3() {
        return responsavel3;
    }

    public void setResponsavel3(JFormattedTextField responsavel3) {
        this.responsavel3 = responsavel3;
    }

    public JComboBox<String> getStatusAtendimento() {
        return statusAtendimento;
    }

    public void setStatusAtendimento(JComboBox<String> statusAtendimento) {
