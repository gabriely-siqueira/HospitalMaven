...
public class AcompanhanteForm extends javax.swing.JDialog {
    
  public AcompanhanteForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        status.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "" }));
        status.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                statusjComboBoxSaguineoActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanelDados3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelDados3Layout.createSequentialGroup()
                        .addGroup(jPanelDados3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelDados3Layout.createSequentialGroup()
                                .addGroup(jPanelDados3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(cpfField, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanelDados3Layout.createSequentialGroup()
                                        .addGap(6, 6, 6)
                                ...
                                .addGroup(jPanelDados3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(telefoneField, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanelDados3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLabelTitulo.setText("Acompanhante");
    ...
    private void statusjComboBoxSaguineoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statusjComboBoxSaguineoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_statusjComboBoxSaguineoActionPerformed
    ...
    public JTextField getGrauParentesco() {
        return grauParentesco;
    }

    public void setGrauParentesco(JTextField grauParentesco) {
    ...
    public JTextField getNomeAcompanhante() {
        return nomeAcompanhante;
    }

    public void setNomeAcompanhante(JTextField nomeAcompanhante) {
    ...
    public void setTelefoneField(JFormattedTextField telefoneField) {
      ...
      public static void main(String args[]) {
         java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AcompanhanteForm dialog = new AcompanhanteForm(new javax.swing.JFrame(), true);
