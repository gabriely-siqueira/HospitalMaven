...
public class TelaBuscaConsulta extends javax.swing.JDialog {

  
    public TelaBuscaConsulta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Responsável", "Data", "Anamnese", "Diagnóstico", "Prescrição", "Observações", "Status"
            }
        ));
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "RESPONSÁVEL", "STATUS", "DIAGNÓSTICO" }));
